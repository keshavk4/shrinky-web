        ...
        <>
            <div className="bg-white text-center py-2 rounded-lg">
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" id="input" className="bg-gray-100 w-[78%] mr-2 px-4 py-2 focus:shadow-[0_0_10px_green] sm:w-[85%] sm:m-0" placeholder="Paste a long url" onChange={handleInputChange} value={userInputURL} required />
                ...
                <p id="result" className={resultStyle}>
                    ...
                    <input type="text" id="input" className="bg-blue-100 w-[83%] mr-2 px-4 py-2 focus:shadow-[0_0_10px_purple] sm:m-0 sm:w-[95%]" value={shortURL} readOnly />
